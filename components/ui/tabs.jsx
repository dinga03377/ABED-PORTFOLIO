...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "text-[#1c1c22] inline-flex h-auto rounded-md p-1",
        className
      )}
      {...props} />
  );
